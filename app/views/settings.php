...
<main class="main narrow">
    ...
    <section class="settings-card">
        ...
        <form method="post" action="/settings" class="settings-form">
            ...
            <label><span>Stats batch size</span><small>Stats requests per progress step. 50 is the default; 100 makes fewer browser round-trips but each request takes longer.</small><input type="number" min="1" max="100" name="batch_size" value="<?= (int) $settings['batch_size'] ?>" required></label>
